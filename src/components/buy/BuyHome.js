...
import {GiFarmTractor, GiHobbitDwelling, GiHomeGarage, GiFamilyHouse, GiKenya} from "react-icons/gi"
...
const BuyLand = () => {
    ...
    useEffect(()=>{
        ...
        db.collection('posts').where("category","==","Homes" ).onSnapshot(snapshot=>{
