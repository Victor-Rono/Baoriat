    ...
    return (
       ...
       <center>
            ...
            <div className="upload-container">
                <FaBookReader color="darkgreen" size={70}/>
            <h5 className="btm-text">Sell or provide a professional service</h5>
...

{
    ...
    <br />
          ...
          <input  type="text" name="" id="business_name" className="image_input" placeholder="name of your service" onChange={e=> setBusinessName(e.target.value)} /> 
            </div>   
    ...
    <select className="form-c" id="exampleFormControlSelect1" name="purpose" onChange={e=>setPurpose(e.target.value)}>
      ...
      <option>Renting</option>
          ...
          <textarea rows="7" cols="25" name="" id="" className="image_input1" placeholder="Give a detailed description of your service and how it can benefit your clients" onChange={e=> setDescription(e.target.value)} />  
          </div>
          ...
          <>In which ward is your physical business premise located?</><br />
        ...
        <option>Ziwa</option>
           ...
           {
               image.length > 3 && description.length > 5 && price !="" && phone.length >=10 && businessName !="" && ward !=""?( <>
