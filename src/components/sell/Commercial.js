            ...
            if(price != ""){
                ...
                if(price.match(/^\d+$/)){
                    ...
                    if(phone.match(/^\d+$/) && (phone.substring(0, 2) === '07' || phone.substring(0, 2) === '01' )){
                        ...
                        } else alert("Invalid number of floors. make sure it has numbers only");


                    } else{alert("Phone should start with 07 or 01 and should have numbers only")}
    ...
    return (
       ...
       <center>
            ...
            <div className="upload-container">
                <FaBuilding color="darkgreen" size={70}/>
            <h5 className="btm-text">Sell or rent out a commercial building</h5>
...

{
    ...
    <br />
          ...
          <input  type="text" name="" id="price" className="image_input" placeholder="" onChange={e=> setBuildingName(e.target.value)} /> 
            </div>    

          <div className="form-group">
           <label>Number of Floors:</label><br />
          <input  type="text" name="" id="size" className="image_input" placeholder="Numbers only" onChange={e=> setFloors(e.target.value)} /> 
            </div>
    ...
    <div className="form-group">
    <label for="exampleFormControlSelect1"><h6>Pay once, montly or annualy?</h6></label> <br />
    <select className="form-c" id="exampleFormControlSelect1" name="purpose" onChange={e=>setPaymentType(e.target.value)}>
      ...
      <option>Negotiable</option>
          ...
          <textarea rows="7" cols="25" name="" id="" className="image_input1" placeholder="Profitability of the building, size, location, distance from town, maintenace costs etc etc.. Give as much information as possible" onChange={e=> setDescription(e.target.value)} />  
          </div>
        ...
        <option>Ziwa</option>
           ...
           {
               image.length > 3 && description.length > 5 && price !="" && floors !="" && buildingName !="" && ward !="" && phone.length >=10?( <>
