 ...
 const links = [];
    ...
    return (
       ...
       <center>
            ...
            <GiFamilyHouse color="darkgreen" size={70}/>
            <h5 className="btm-text">Sell or rent out your home or apartment</h5>
...

{
    ...
    <br />
          ...
          <input  type="number" name="" id="size" className="image_input" placeholder="numbers only" onChange={e=> setRooms(e.target.value)} /> 
            </div>
...
<option>Ziwa</option>
           ...
           {
               image.length > 3 && description.length > 5 && price !="" && phone.length >=10 && rooms !="" && ward !=""?( <>
